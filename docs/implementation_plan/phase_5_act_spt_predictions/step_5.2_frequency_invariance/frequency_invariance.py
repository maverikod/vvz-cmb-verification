...
class FrequencyInvarianceTester:
    ...
    def __init__(
        self, frequency_maps: Dict[float, np.ndarray], frequencies: List[float]
    ):
        """
        Initialize tester.
    ...
    def test_invariance(
        self, cross_spectra: List[CrossSpectrum]
    ...
    def validate_achromaticity(self, result: InvarianceTestResult) -> bool:
        """
