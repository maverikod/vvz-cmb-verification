...
class PredictionsReportGenerator:
    ...
    def generate_report(self, output_path: Optional[Path] = None) -> PredictionsReport:
        """
    ...
    def validate_framework(
        self, predictions: List[PredictionSummary]
    ) -> Dict[str, Any]:
        """
    ...
    def create_visualizations(
        self, report: PredictionsReport, output_dir: Path
    ) -> List[Path]:
        """
